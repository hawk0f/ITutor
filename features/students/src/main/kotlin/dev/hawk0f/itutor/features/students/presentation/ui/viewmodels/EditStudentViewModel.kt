...
@HiltViewModel
class EditStudentViewModel @Inject constructor(private val getStudentByIdUseCase: GetStudentByIdUseCase, val validateName: ValidateName, val validateAge: ValidateAge, val validatePhone: ValidatePhone, val validatePrice: ValidatePrice, private val updateStudentUseCase: UpdateStudentUseCase) : BaseViewModel()
{
    private var oldName = ""
