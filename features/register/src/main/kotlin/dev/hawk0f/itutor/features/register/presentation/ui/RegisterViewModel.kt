...
import dev.hawk0f.itutor.features.register.presentation.models.UserUI
import dev.hawk0f.itutor.features.register.presentation.models.toUi
...
class RegisterViewModel @Inject constructor(private val registerUserUseCase: RegisterUserUseCase) : BaseViewModel()
{
    ...
    fun registerUser() = registerUserUseCase(UserDTO(name = name, surname = surname, email = email, phoneNumber = null, password = password)).collectNetworkRequest(_regState) {
        it.toUi()
    }
