...
class ChooseStudentAdapter(private val onCheckBoxClick: (studentId: Int) -> Unit) : ListAdapter<LessonStudentUI, ChooseStudentAdapter.ChooseStudentViewHolder>(BaseDiffUtilItemCallback())
{
    ...
    {
        fun bind(studentUi: LessonStudentUI, onCheckBoxClick: (studentId: Int) -> Unit) = with(binding) {
            student = studentUi
