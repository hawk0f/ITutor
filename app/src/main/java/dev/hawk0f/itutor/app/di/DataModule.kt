...
object DataModule
{
    ...
    @Singleton
    @Provides
    fun provideRegisterUserRepository(service: dev.hawk0f.itutor.features.register.data.network.apiservices.UserService): dev.hawk0f.itutor.features.register.domain.repositories.UserRepository = dev.hawk0f.itutor.features.register.data.repositories.UserRepositoryImpl(service)
    ...
    @Singleton
    @Provides
    fun provideRegisterUserService(client: NetworkClient) = client.provideApiService<dev.hawk0f.itutor.features.register.data.network.apiservices.UserService>()
