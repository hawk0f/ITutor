package dev.hawk0f.itutor.finance.presentation.ui.fragments
...
import dev.hawk0f.itutor.databinding.FragmentDiagramBinding
import dev.hawk0f.itutor.finance.presentation.models.LessonStudentUI
import dev.hawk0f.itutor.finance.presentation.ui.custom.MyMarkerViewKt
import dev.hawk0f.itutor.finance.presentation.ui.viewmodels.DiagramViewModel
...
class DiagramFragment : BaseFragment<DiagramViewModel, FragmentDiagramBinding>(R.layout.fragment_diagram), OnChartValueSelectedListener
{
    ...
    private fun setData(entriesGroup1: List<BarEntry>, entriesGroup2: List<BarEntry>) = with(binding) {
        ...
        {
            set1 = BarDataSet(entriesGroup1, getString(dev.hawk0f.itutor.core.R.string.actual_revenue))
            set1.setColor(Color.rgb(104, 241, 175))
            set2 = BarDataSet(entriesGroup2, getString(dev.hawk0f.itutor.core.R.string.expected_revenue))
