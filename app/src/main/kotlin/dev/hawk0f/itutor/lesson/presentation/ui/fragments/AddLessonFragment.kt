...
import dev.hawk0f.itutor.databinding.FragmentAddLessonBinding
import dev.hawk0f.itutor.lesson.presentation.ui.adapters.LessonStudentsAdapter
import dev.hawk0f.itutor.lesson.presentation.ui.viewmodels.AddLessonViewModel
...
class AddLessonFragment : BaseFragment<AddLessonViewModel, FragmentAddLessonBinding>(R.layout.fragment_add_lesson)
{
    ...
    private fun subscribeToAdd() = with(binding) {
        viewModel.addState.collectAsUIState(state = {
            ...
            showToastLong(dev.hawk0f.itutor.core.R.string.success_lesson_added)
