...
import dev.hawk0f.itutor.databinding.FragmentEditStudentBinding
import dev.hawk0f.itutor.student.presentation.ui.viewmodels.EditStudentViewModel
...
class EditStudentFragment : BaseFragment<EditStudentViewModel, FragmentEditStudentBinding>(R.layout.fragment_edit_student)
{
    ...
    private fun subscribeToUpdate() = with(binding) {
        viewModel.updateState.collectAsUIState(state = {
            ...
            showToastLong(dev.hawk0f.itutor.core.R.string.success_student_updated)
