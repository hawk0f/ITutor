...
import dev.hawk0f.itutor.databinding.FragmentEditNoteBinding
import dev.hawk0f.itutor.note.presentation.ui.viewmodels.EditNoteViewModel
...
class EditNoteFragment : BaseFragment<EditNoteViewModel, FragmentEditNoteBinding>(R.layout.fragment_edit_note)
{
    ...
    private fun subscribeToUpdate() = with(binding) {
        viewModel.updateState.collectAsUIState(state = {
            ...
            showToastLong(dev.hawk0f.itutor.core.R.string.success_note_updated)
